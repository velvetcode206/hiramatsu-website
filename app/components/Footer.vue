...
const links: ILink[] = [
  ...
  {
    to: 'https://www.instagram.com/escola_samurai',
    name: 'instagram',
  },
  {
    to: 'https://www.youtube.com/channel/UCdj_dmfO7c2470OzweQM9XA',
    name: 'youtube',
  },
]
</script>
...
<template>
  <div class="flex mt-auto bg-white">
    <div class="flex flex-col gap-4 px-4 py-8 lg:gap-8 lg:px-8 lg:py-16 wrapper-desktop">
